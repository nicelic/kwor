...
type AcmeCertificate struct {
	...
	MainDomain string `json:"mainDomain" gorm:"index;size:255;not null"`
	DomainSet  string `json:"domainSet" gorm:"type:text;not null"`
	...
	Challenge       string `json:"challenge" gorm:"size:32;not null;default:'standalone'"`
	KeyLength       string `json:"keyLength" gorm:"size:32;not null;default:'ec-256'"`
	CAServer        string `json:"caServer" gorm:"size:128;not null;default:'letsencrypt'"`
	UseECC          bool   `json:"useEcc" gorm:"not null;default:true"`
