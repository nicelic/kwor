<template>
  <v-card :subtitle="$t('objects.tls')">
    ...
    <template v-if="tls.enabled">
      ...
      <v-row v-if="supportsClientFingerprint && tls.utls != undefined">
        <v-col cols="12" md="6">
          <v-select
            hide-details
            label="Fingerprint"
      ...
      <v-row v-if="supportsReality && tls.reality != undefined">
        <v-col cols="12" md="6">
          <v-text-field
          :label="$t('tls.pubKey')"
            hide-details
      ...
      <v-menu v-model="menu" :close-on-content-click="false" location="start">
          ...
          <v-card>
            <v-list>
              ...
              <v-list-item v-if="supportsClientFingerprint">
...
export default {
  ...
  computed: {
    ...
    optionReality: {
      get(): boolean { return this.supportsReality && this.tls.reality != undefined },
      set(v:boolean) {
        if (!this.supportsReality) {
          delete this.$props.outbound.tls.reality
          return
